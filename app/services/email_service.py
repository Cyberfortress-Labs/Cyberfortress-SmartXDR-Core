...
class EmailService:
    ...
    def _build_html_email(
        ...
        time_str = local_time.strftime(f'%B %d, %Y at %H:%M ({offset_str})')
        report_time_str = local_time.strftime(f'%Y-%m-%d %H:%M:%S ({offset_str})')
...
<body>
    <div class="header">
        ...
        <p style="color: #ffffff !important;">{time_str}</p>
    </div>
...
"""
    ...
    <div class="footer">
        ...
        <p>Report Time: """ + report_time_str + """</p>
    </div>
</body>
</html>
"""
