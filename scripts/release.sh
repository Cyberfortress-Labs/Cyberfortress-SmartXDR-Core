...
echo -e "${BLUE}=== SmartXDR Release Script ===${NC}"
...
echo ""
echo -e "Check progress at: ${BLUE}https://github.com/Cyberfortress-Labs/Cyberfortress-SmartXDR-Core/actions${NC}"
